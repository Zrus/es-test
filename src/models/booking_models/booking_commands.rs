...
impl BookingCommands {
  pub fn add_booking(customer: Customer, service: Vec<(Staff, Service, (DateTime<Utc>, DateTime<Utc>))>, created_date: DateTime<Utc>, booking_date: DateTime<Utc>) -> BookingCommands {
